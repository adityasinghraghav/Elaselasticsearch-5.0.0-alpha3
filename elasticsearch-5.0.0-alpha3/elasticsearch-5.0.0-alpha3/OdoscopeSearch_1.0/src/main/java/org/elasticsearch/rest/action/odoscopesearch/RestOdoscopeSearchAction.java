...
import org.elasticsearch.plugin.odoscopesearch.SearchRequestParser;
import org.elasticsearch.plugin.odoscopesearch.OdoscopeSearchParseException;
...
public class RestOdoscopeSearchAction extends BaseRestHandler {
    ...
    @Inject
    public RestOdoscopeSearchAction(Settings settings, RestController controller, Client client) {
        super(settings, controller, client);
        controller.registerHandler(GET, "/_odoscope", this);
        controller.registerHandler(POST, "/_odoscope", this);
        controller.registerHandler(GET, "/{index}/_odoscope", this);
        controller.registerHandler(POST, "/{index}/_odoscope", this);
        controller.registerHandler(GET, "/{index}/{type}/_odoscope", this);
        controller.registerHandler(POST, "/{index}/{type}/_odoscope", this);
        controller.registerHandler(GET, "/_odoscope/template", this);
        controller.registerHandler(POST, "/_odoscope/template", this);
        controller.registerHandler(GET, "/{index}/_odoscope/template", this);
        controller.registerHandler(POST, "/{index}/_odoscope/template", this);
        controller.registerHandler(GET, "/{index}/{type}/_odoscope/template", this);
        controller.registerHandler(POST, "/{index}/{type}/_odoscope/template", this);

        RestExistsAction restExistsAction = new RestExistsAction(settings, controller, client);
        controller.registerHandler(GET, "/_odoscope/exists", restExistsAction);
        controller.registerHandler(POST, "/_odoscope/exists", restExistsAction);
        controller.registerHandler(GET, "/{index}/_odoscope/exists", restExistsAction);
        controller.registerHandler(POST, "/{index}/_odoscope/exists", restExistsAction);
        controller.registerHandler(GET, "/{index}/{type}/_odoscope/exists", restExistsAction);
        controller.registerHandler(POST, "/{index}/{type}/_odoscope/exists", restExistsAction);
    }
    ...
    public void handleRequest(final RestRequest request, final RestChannel channel, final Client client) {
        ...
        else
        {
            ...
            simple.setSearchRequest(searchRequest);
            SearchResponse response = client.execute(OdoscopeSearchAction.INSTANCE, simple).actionGet();
    ...
    public static SearchSourceBuilder parseSearchSource(RestRequest request) {
        ...
        if(from!=-1)
        {
            SavedValues.setFrom(from);
        }

        int size = request.paramAsInt("size", -1);
        if(size!=-1)
        {
            SavedValues.setSize(size);
        }
