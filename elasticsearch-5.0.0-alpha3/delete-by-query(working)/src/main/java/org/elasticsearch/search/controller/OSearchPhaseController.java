...
public class OSearchPhaseController {
    ...
    public InternalSearchHits odoscope(InternalSearchHits InHits, long totalHits)
    {
        ...
        String skus[] = new String[SavedValues.getS()];
        ...
        InternalSearchHit finalfinalhits[] = new InternalSearchHit[SavedValues.getS()];


        count = 0;

        for (int itr = finalhits.length - 1; itr > -1; itr--) {
            if (count == (SavedValues.getS())) {
                break;
            }
