...
import static org.elasticsearch.action.search.OTransportSearchHelper.internalSearchRequest;

abstract class OAbstractSearchAsyncAction<FirstResult extends SearchPhaseResult> extends OAbstractAsyncAction {
    ...
    protected OAbstractSearchAsyncAction(ESLogger logger, SearchServiceTransportAction searchService, ClusterService clusterService,
