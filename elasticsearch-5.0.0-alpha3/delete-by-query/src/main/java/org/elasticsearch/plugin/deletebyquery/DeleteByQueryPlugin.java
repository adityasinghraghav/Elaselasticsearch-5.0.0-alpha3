...
import org.elasticsearch.action.search.TransportDeleteByQueryAction;
...
public class DeleteByQueryPlugin extends Plugin {
    ...
    public void onModule(ActionModule actionModule) {
        actionModule.registerAction(SimpleAction.INSTANCE, TransportDeleteByQueryAction.class);
    }
