...
import static org.elasticsearch.action.search.OdoscopeTransportSearchHelper.internalSearchRequest;
...
abstract class OdoscopeAbstractSearchAsyncAction<FirstResult extends SearchPhaseResult> extends OdoscopeAbstractAsyncAction {
    ...
    protected OdoscopeAbstractSearchAsyncAction(ESLogger logger, SearchServiceTransportAction searchService, ClusterService clusterService,
